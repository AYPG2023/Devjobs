<form class="md:w-1/2 space-y-5"> <!-- Separada todos sus hijos o cada boton -->
    ...
    <div>
        ...
        <x-text-input id="titulo"
            ...
            type="text" name="titulo" :value="old('titulo')" required autofocus autocomplete="titulo"
    ...
    <div>
        ...
        <x-text-input id="empresa"
            class="block mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full"
            type="text" name="empresa" :value="old('empresa')" required autofocus autocomplete="empresa"
    ...
    <div>
        ...
        <x-text-input id="ultimo_dia"
            class="block mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full"
            type="date" name="ultimo_dia" :value="old('ultimo_dia')" required autofocus autocomplete="ultimo_dia" />
    ...
    <div>
        ...
        <textarea id="descripcion"
            ...
            name="descripcion" placeholder="Descripción del trabajo" required autofocus autocomplete="descripcion">{{ old('descripcion') }}</textarea>
